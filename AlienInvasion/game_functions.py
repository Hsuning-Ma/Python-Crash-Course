...
def check_keyup_evnets(event, ship) :
...
def get_number_aliens_x(ai_settings, alien_width) :
  ...
  number_alients_x = int(available_space_x/(2*alien_width))
  return number_alients_x
...
def create_fleet(ai_settings, screen, ship, aliens) :
  ...
  alien = Alien(ai_settings, screen)
  number_alients_x = get_number_aliens_x(ai_settings, alien.rect.width)
